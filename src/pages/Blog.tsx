  ...
  return (
    <div>
      <section className="relative h-[30vh] flex items-center justify-center bg-primary">
        <h1 className="text-4xl md:text-5xl font-display font-bold text-primary-foreground">Blog</h1>
      </section>
            ...
            {posts.map((post) => (
              <article key={post.id} className="card-salon group">
                ...
                <div className="p-5">
                  ...
                  <button className="text-sm text-gold font-medium hover:underline">Ler mais →</button>
                </div>
              </article>
            ))}
          </div>
